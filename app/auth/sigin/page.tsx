...
export default function Login() {
  const URL_END = "https://ufuon-store.vercel.app/api/auth/login";
  ...
  const handleSubmit = async (e: any) => {
    e.preventDefault();
    setLoadingin(true);
    console.log("data-------------->", credentials.email, credentials.password);
    let emailRegex =
    ...
    try {
      if (!credentials.email && !credentials.password) {
        ...
        console.log("data-----------55--->", credentials.email);
        const sendAuth = await axios.post(`${URL_END}`, {
      ...
      error.status === 404
        ? // toast.error('kgjdfkjlkd', { autoClose: 500, theme: 'colored' })
      ...
      <div className="cart-section">
        <div className="sigin-body">
          <div className="sigin-img">
            <img
              src="https://res.cloudinary.com/codepally/image/upload/v1735234522/login.svg_fill_1_ojuo1g.png"
              alt="img"
            />
          </div>
          ...
          <div className="sigin-detail">
            ...
            <form onSubmit={handleSubmit}>
              ...
              {loading === true ? (
                ...
                <button className="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-10 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                  Login
                </button>
              )}
            </form>
