 ...
 const callCategories = async () => {
    ...
    const removeProductData = async(data , index) =>{
      ...
      var product = removeBook[0]
        ...
        if(removeBook.length === 0){
          ...
          try {
           const { data } = await axios.put(`${URL_LOCAL_END}/sections/${sectionData._id}`,
                    {
                      products: removeBook
                    }, {
                    headers: {
  ...
  const EditCollection = () =>{
    ...
    const UpdateSubmit = async (e) =>{
      e.preventDefault()
      setLoadingData(true)
      console.log('---------UpdateSubmit--------1---------data',productInfo.name,productInfo.Description,type)
      try {
          if (!productInfo.name ) {
            ...
            console.log('---------UpdateSubmit--------2---------data',productInfo.name,`${URL_LOCAL_END}/${sectionData._id}`)
              const { data } = await axios.put(`${URL_LOCAL_END}/sections/${sectionData._id}`,
                  {
   ...
   function ToSeoUrl(url) {
    ...
    const dataForSwitch = async()=>{
      ...
      try {
            ...
            const { data } = await axios.post(`${URL_LOCAL_END}/sections/publish`,
                {
                  id:sectionData._id,
                    publish:!publish
                }, {
                   ...
                   <div className="xl:col-span-3 w-full project-detail">
                       <div className='project-share'>
                        <div className="flex   myProject-button">
                            ...
                            <button  onClick={()=>EditCollection()}  type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg ml-1 text-sm p-2 h-8 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={()=>EditCollection()}>Edit
                           ...
                           </button>
                           {
                            ...
                            :
                                <div>
                                      {
                                        publish ?
                                        <button   onClick={(() => dataForSwitch())} type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg ml-1 text-sm p-2 h-8 text-center inline-flex items-center me-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" >Publish
                                              <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                                <path fill-rule="evenodd" d="M4.998 7.78C6.729 6.345 9.198 5 12 5c2.802 0 5.27 1.345 7.002 2.78a12.713 12.713 0 0 1 2.096 2.183c.253.344.465.682.618.997.14.286.284.658.284 1.04s-.145.754-.284 1.04a6.6 6.6 0 0 1-.618.997 12.712 12.712 0 0 1-2.096 2.183C17.271 17.655 14.802 19 12 19c-2.802 0-5.27-1.345-7.002-2.78a12.712 12.712 0 0 1-2.096-2.183 6.6 6.6 0 0 1-.618-.997C2.144 12.754 2 12.382 2 12s.145-.754.284-1.04c.153-.315.365-.653.618-.997A12.714 12.714 0 0 1 4.998 7.78ZM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" clip-rule="evenodd"/>
                                          </svg>
                                        </button>
                                        :
                                        <button  onClick={(() => dataForSwitch())} type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg ml-1 text-sm p-2 h-8 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" >Publish
                                                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                                <path fill-rule="evenodd" d="M4.998 7.78C6.729 6.345 9.198 5 12 5c2.802 0 5.27 1.345 7.002 2.78a12.713 12.713 0 0 1 2.096 2.183c.253.344.465.682.618.997.14.286.284.658.284 1.04s-.145.754-.284 1.04a6.6 6.6 0 0 1-.618.997 12.712 12.712 0 0 1-2.096 2.183C17.271 17.655 14.802 19 12 19c-2.802 0-5.27-1.345-7.002-2.78a12.712 12.712 0 0 1-2.096-2.183 6.6 6.6 0 0 1-.618-.997C2.144 12.754 2 12.382 2 12s.145-.754.284-1.04c.153-.315.365-.653.618-.997A12.714 12.714 0 0 1 4.998 7.78ZM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" clip-rule="evenodd"/>
                                          </svg>
                                        </button>
                           ...
                           <a href='/my-project/list' class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm ml-1 p-2 h-8 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"> Products 
                                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                      ...
                      </div>  
                      {
                       ...
                       
                       {
                        props.products ===  undefined ?
                         null
                         :
                         <p className="text-gray-800 text-2xl font-bold">{moneyFormat(totalProduct)}</p>
                       }
                       ...
                       
                       {
                        products .map((item, index) => (
                            <div   key={index}   class="flex max-sm:flex-col items-center gap-6 overflow-hidden cursor-pointer">
                                <div onClick={()=>ClickToShow(item)} class="w-24 h-24 shrink-0 bg-gray-100 p-3 overflow-hidden rounded-lg">
                                  <img  src={item.images[0].url}  alt="product1"
                                  class="h-full w-full object-contain" />
                                </div>
                                <div class=" max-sm:text-center">
                                     
                                   <h3 class="text-sm sm:text-base font-bold text-gray-800" onClick={()=>ClickToShow(item)}> { item.name.length > 19 ? item.name.slice(0, 19) + '...' : item.name}</h3>
                                   <h4 class="text-sm sm:text-base text-blue-600 font-bold mt-2 " onClick={()=>ClickToShow(item)}> {moneyFormat(item.price)}</h4>
                                    {
                                        loadingData ?
                                      ...
                                      :
                                      <button   onClick={()=>GetProductModal(item,index)} type="button" class="text-white float-right bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none flont focus:ring-red-300 font-medium rounded-lg ml-1 text-sm p-2 h-8 text-center inline-flex items-center me-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800" >
                                          <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                          <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18 17.94 6M18 18 6.06 6"/>
                                        </svg>
                                      </button>
                               ...
                               <div className='myproject-imageIcon'>
                                      ...
                                      <div class="relative">
                                        <select onChange={handleType}
                                            ...
                                            {projects.map(item =>     
                                               <option value="brazil" label={item.name} key={item.name} value={item._id}  >{item.name}</option>
                                            )}
                                    ...
                                    {
                                      showImageUi === true ? 
                                       <button type="button" onClick={()=>openImageBack(!openImage)} class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm ml-1 p-2 h-8 text-center inline-flex items-center me-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800" >
                                             <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                      ...
                                      :
                                    <button type="button" onClick={()=>openImageData(!openImage)} class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm ml-1 p-2 h-8 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" >
                                         Add 
                                         <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="sm:flex sm:items-start">
                                  ...
                                  <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    <h3 class="text-base font-semibold text-gray-900" id="modal-title">Edit Project</h3>
                               ...
                               <div className="mb-2 pl-2 pr-2">
                                   {
                                      ...
                                      <div>
                                      <form>
                                          <small style={{ float:'right',color:'red'}}>Length of image {files.length}</small>
                                          {
                                            files.length === 0 ?
                                              ...
                                              // <h4>Edit Collections</h4>
                                                ...
                                                <div style={{width:'100%'}}>
                                                        <div className="mb-2 ml-1">
                                                            <label className="block mb-2 text-sm font-medium text-black dark:text-black-500">Name</label>
                                                            <input type="text" id="success" label="name" name='name'   value={productInfo.name}   onChange={handleOnchange}  variant="outlined"
                                                            className="bg-black-50 border border-green-500 text-green-900 dark:text-black-400 placeholder-green-700 dark:placeholder-black-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 white w-full p-2.5 dark:bg-white-700 dark:border-blue-500" placeholder="Name"/>
                                                            {
                                                        ...
                                                        <div className="mb-2 ml-1">
                                                            <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Title</label>
                                                            <textarea id="message"   rows="4"  name='Description'    value={productInfo.Description} onChange={handleOnchange}   class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."></textarea>
                                                          </div>
                                                          <div className="mb-2 ml-1">
                        ...
                        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                          <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                            ...
                            <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                              <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div class="sm:flex sm:items-start">
                                  ...
                                  <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    <div class="mt-2">
                                      <p class="text-sm text-gray-500">Are you sure you want to  delete this product? {productDelete.data.name}.</p>
                                    </div>
                                  </div>
                                </div>
                              </div>
                              ...
                              :
                              <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                  <button type="button"  onClick={()=>removeProductData(productDelete.data,productDelete.index)} class="inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-red-500 sm:ml-3 sm:w-auto">Delete</button>
                                  <button type="button" onClick={() => handleClose()} class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-gray-50 sm:mt-0 sm:w-auto">Cancel</button>
                                </div>
                              }
