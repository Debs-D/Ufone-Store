...
import ProjectSlide from '../../../components/projectConponent/projectDetail'
import './project.css'
const URL_END = "https://ufuon-store.vercel.app/api";
const URL_LOCAL_END = "http://localhost:43000/api";

// import ProjectSlide from '../../../components/projectConponent/projectDetail.js'
...
export default async function ProjectId({ params }: { params: { id: string } }) { 
  ...
  return (
    <div>
            <ProjectSlide section={product.data} id={getID}  products={formattedData(product.data.products, product.data.quantity)} />
